...
# Bedrock client shim plus shared state (oba uzywane przez solve-pipeline.js
# i heroku-start.js gdy BEDROCK_MODEL_ARN ustawione)
COPY bedrock-bielik/llm-client.mjs bedrock-bielik/state.mjs ./bedrock-bielik/
